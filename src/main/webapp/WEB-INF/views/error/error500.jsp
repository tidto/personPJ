...
<section class="hero-section overflow-hidden">
    <div class="hero-slider owl-carousel">
        ...
        data-setbg="${pageContext.request.contextPath}/assets/img/이상해요.gif">
            <div class="container">
                <h2 style="color:#B01BA5">5 0 0 .</h2>
                ...
                <a href="/home.do" class="site-btn">BACK HOME<img src="${pageContext.request.contextPath}/assets/img/icons/double-arrow.png" alt="#"/></a>
            </div>
        </div>
    </div>
</section>
